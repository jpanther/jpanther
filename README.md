...
- [jpanther/lynx](https://github.com/jpanther/lynx) - A simple links theme for Hugo built with Tailwind CSS. (2 months ago)
...
- [jpanther/congo](https://github.com/jpanther/congo) ([v1.6.4](https://github.com/jpanther/congo/releases/tag/v1.6.4), 5 days ago) - A simple, lightweight theme for Hugo built with Tailwind CSS.
- [jpanther/lynx](https://github.com/jpanther/lynx) ([v1.1.0](https://github.com/jpanther/lynx/releases/tag/v1.1.0), 2 months ago) - A simple links theme for Hugo built with Tailwind CSS.
