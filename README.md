...
- [jpanther/lynx](https://github.com/jpanther/lynx) ([v1.2.4](https://github.com/jpanther/lynx/releases/tag/v1.2.4), 1 day ago) - A simple links theme for Hugo built with Tailwind CSS.
- [jpanther/congo](https://github.com/jpanther/congo) ([v2.5.0](https://github.com/jpanther/congo/releases/tag/v2.5.0), 1 day ago) - A powerful, lightweight theme for Hugo built with Tailwind CSS.
