...
- [jpanther/congo](https://github.com/jpanther/congo) ([v1.5.2](https://github.com/jpanther/congo/releases/tag/v1.5.2), 2 days ago) - A simple, lightweight theme for Hugo built with Tailwind CSS.
- [jpanther/lynx](https://github.com/jpanther/lynx) ([v1.1.0](https://github.com/jpanther/lynx/releases/tag/v1.1.0), 6 days ago) - A simple links theme for Hugo built with Tailwind CSS.
