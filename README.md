...
- [jpanther/congo](https://github.com/jpanther/congo) ([v1.3.0](https://github.com/jpanther/congo/releases/tag/v1.3.0), 1 week ago) - A simple, lightweight theme for Hugo built with Tailwind CSS.
- [jpanther/dectorio](https://github.com/jpanther/dectorio) ([v0.12.5](https://github.com/jpanther/dectorio/releases/tag/v0.12.5), 4 weeks ago) - Dectorio is a large mod that adds decorative elements to Factorio.
