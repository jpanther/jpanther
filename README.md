...
- [jpanther/lynx](https://github.com/jpanther/lynx) ([v1.2.1](https://github.com/jpanther/lynx/releases/tag/v1.2.1), 1 week ago) - A simple links theme for Hugo built with Tailwind CSS.
- [jpanther/congo](https://github.com/jpanther/congo) ([v2.3.1](https://github.com/jpanther/congo/releases/tag/v2.3.1), 4 weeks ago) - A powerful, lightweight theme for Hugo built with Tailwind CSS.
