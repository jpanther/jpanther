...
- [jpanther/congo](https://github.com/jpanther/congo) ([v1.5.3](https://github.com/jpanther/congo/releases/tag/v1.5.3), 1 week ago) - A simple, lightweight theme for Hugo built with Tailwind CSS.
- [jpanther/lynx](https://github.com/jpanther/lynx) ([v1.1.0](https://github.com/jpanther/lynx/releases/tag/v1.1.0), 2 weeks ago) - A simple links theme for Hugo built with Tailwind CSS.
