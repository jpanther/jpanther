...
- [jpanther/congo](https://github.com/jpanther/congo) ([v2.3.0](https://github.com/jpanther/congo/releases/tag/v2.3.0), 1 day ago) - A powerful, lightweight theme for Hugo built with Tailwind CSS.
- [jpanther/dectorio](https://github.com/jpanther/dectorio) ([v0.12.6](https://github.com/jpanther/dectorio/releases/tag/v0.12.6), 5 days ago) - Dectorio is a large mod that adds decorative elements to Factorio.
