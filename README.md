...
- [jpanther/dectorio](https://github.com/jpanther/dectorio) ([v0.13.1](https://github.com/jpanther/dectorio/releases/tag/v0.13.1), 4 weeks ago) - Dectorio is a large mod that adds decorative elements to Factorio.
...
- [jpanther/lynx](https://github.com/jpanther/lynx) ([v1.4.0](https://github.com/jpanther/lynx/releases/tag/v1.4.0), 7 months ago) - A simple links theme for Hugo built with Tailwind CSS.
